...
For complete rationale and detailed architecture specifications, consult [`.agents/skills/design-guidelines/SKILL.md`](.agents/skills/design-guidelines/SKILL.md), [`.agents/skills/design-guidelines/REFERENCE.md`](.agents/skills/design-guidelines/REFERENCE.md), and the [`knowledge/design/`](knowledge/design/) ADR corpus.
...
|---|---|---|---|
| **Buttons & CTAs** | Max 1 primary CTA per surface; variant matches risk; persistent utilities are icon-only; primary toolbar CTA is icon+text | [ADR 0029](knowledge/design/0029-button-hierarchy-states.md) / [ADR 0043](knowledge/design/0043-button-text-vs-icon-rules.md) | [Reference: Buttons](.agents/skills/design-guidelines/REFERENCE.md#source-reference-map) |
| **Modals & Dialogs** | `AlertDialog` for destructive/high-stakes; standard `Dialog` for forms; `Sheet` for context; Cancel on left, Confirm right | [ADR 0032](knowledge/design/0032-modal-dialog-standards.md) | [Reference: Dialogs](.agents/skills/design-guidelines/REFERENCE.md#dialog-type-for-an-action) |
| **Forms & Inputs** | Labels strictly above inputs; blur-triggered validation; fieldset grouping with `space-8` | [ADR 0025](knowledge/design/0025-forms-inputs.md) | [Reference: Forms](.agents/skills/design-guidelines/REFERENCE.md#forms-quick-rules) |
| **Tables & Grids** | Text left-aligned, numeric right-aligned; Concept C sub-label stacking; zero badges, pills, or gridlines | [ADR 0034](knowledge/design/0034-table-design-standards.md) | [Reference: Tables](.agents/skills/design-guidelines/REFERENCE.md#key-rules-inline-reference) |
| **Cards & Elevation** | Use 5-tier shadow scale (`shadow-xs`→`shadow-xl`); cards are borderless at rest; use `surface` prop | [ADR 0041](knowledge/design/0041-surface-tier-system.md) | [Reference: Shadows](.agents/skills/design-guidelines/REFERENCE.md#shadow--elevation-tiers) |
| **Navigation & Header** | 3 zones only (search / empty / utility+avatar); fixed `h-16`; zero navigation links in header bar | [ADR 0037](knowledge/design/0037-navigation-header-bar.md) | [Reference: Header](.agents/skills/design-guidelines/REFERENCE.md#toolbar--header-principles) |
| **Page Toolbars** | Max 52px single-row across all viewports; 7-stage priority collapse; persistent `MoreVertical` anchor; 200–300ms tooltip delay | [ADR 0039](knowledge/design/0039-toolbar-header-standards.md) | [Reference: Toolbars](.agents/skills/design-guidelines/REFERENCE.md#toolbar--header-principles) |
| **Status / Badges** | **Total ban** on `badge.tsx`, colored status dots, and pills; use Concept C sub-label stacking or Concept A margin wash | [ADR 0035](knowledge/design/0035-badge-status-indicators.md) | [Reference: Badge Ban](.agents/skills/design-guidelines/REFERENCE.md#query-mode-fast-lookup) |
| **Alert Colors at Rest** | Zero semantic colors (`destructive`, `success`, `warning`) on resting surfaces; permitted only in toasts, open dialogs, validation, or active hover | [ADR 0020](knowledge/design/0020-color-system.md) / [ADR 0036](knowledge/design/0036-destructive-action-confirmation.md) | [Reference: Color](.agents/skills/design-guidelines/REFERENCE.md#color-architecture) |
| **Toasts & Alerts** | Success auto-dismisses in 4s; error toasts persist; max 3 concurrent; undo toast for soft deletes; toast ≠ bell notification | [ADR 0033](knowledge/design/0033-toast-notification-rules.md) | [Reference: Toasts](.agents/skills/design-guidelines/REFERENCE.md#key-rules-inline-reference) |
| **Charts & Data Viz** | Labeled axes with units; accessible OKLCH palette (≥30° hue delta); mandatory screen-reader tabular alternative | [ADR 0026](knowledge/design/0026-data-visualization.md) | [Reference: Data Viz](.agents/skills/design-guidelines/REFERENCE.md#data-visualization-rules) |
| **Multi-Step Wizards** | 3-zone layout (sidebar tree / canvas / live preview); auto-save drafts; `Next` button never disabled (click-to-validate) | [ADR 0042](knowledge/design/0042-multi-step-wizards.md) | [Reference: Wizards](.agents/skills/design-guidelines/REFERENCE.md#key-rules-inline-reference) |
| **Mobile Footer / FAB** | Single app-wide bottom paradigm; 1–3 slot layout contract; safe-area bottom scroll buffer `pb-[calc(4rem+env(safe-area-inset-bottom))]` | [ADR 0045](knowledge/design/0045-mobile-sticky-footer-and-fab-patterns.md) | [Reference: Mobile](.agents/skills/design-guidelines/REFERENCE.md#mobile-bottom-actions) |
| **Scrollbars** | Hidden at rest; visible only on active scrolling; 300ms idle persistence before 150ms fade-out; zero-width overlay layout | [ADR 0044](knowledge/design/0044-scrollbar-auto-hide-standards.md) | [Reference: Scrollbar](.agents/skills/design-guidelines/REFERENCE.md#scrollbar-auto-hide) |
| **Typography & Copy** | 6-tier modular scale capped at 24px (`text-2xl`) in app UI; Title Case in UI, camelCase in code; verb-first labels; em-dash (`—`) for unknowns | [ADR 0015](knowledge/design/0015-style-guide.md) / [ADR 0019](knowledge/design/0019-typography.md) / [ADR 0030](knowledge/design/0030-content-formatting.md) / [ADR 0031](knowledge/design/0031-ux-copy-microcopy.md) | [Reference: Typography](.agents/skills/design-guidelines/REFERENCE.md#typography-scale) |
