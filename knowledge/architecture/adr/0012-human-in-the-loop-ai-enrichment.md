...
## Context
Automated background AI data enhancements (scraping directories or sites) can hallucinate or fetch out-of-date information, which corrupt authoritative CRM profiles if applied autonomously.
...
## Consequences
- Protects core CRM database integrity from AI hallucination or ingestion drift.
